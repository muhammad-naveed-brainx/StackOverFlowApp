...
Route::get('/ask-question', [QuestionController::class, 'create'])->name('question.create')->middleware('auth');
...
Route::post('/answers/{id}', [AnswerController::class, 'store'])->name('answer.store')->middleware('auth');
